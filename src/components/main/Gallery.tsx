      ...
      <div className="mx-auto max-w-screen-2xl px-4 md:px-8">
        ...
        <div className="mb-4 grid grid-cols-2 gap-4 sm:grid-cols-3 md:mb-8 md:grid-cols-4 md:gap-6 xl:gap-8">
          ...
          <a href="#" className="group relative flex h-48 items-end overflow-hidden rounded-lg bg-gray-100 shadow-lg md:h-80">
            ...
            <span className="relative mb-3 ml-4 inline-block text-sm text-white md:ml-5 md:text-lg">技術</span>
          </a>
          ...
          <a href="#" className="group relative flex h-48 items-end overflow-hidden rounded-lg bg-gray-100 shadow-lg md:h-80">
            ...
            <span className="relative mb-3 ml-4 inline-block text-sm text-white md:ml-5 md:text-lg">開発</span>
          </a>
          ...
          <a href="#" className="group relative flex h-48 items-end overflow-hidden rounded-lg bg-gray-100 shadow-lg md:h-80">
            ...
            <span className="relative mb-3 ml-4 inline-block text-sm text-white md:ml-5 md:text-lg">レトロ</span>
          </a>
        </div>
        <div className="flex items-start justify-between gap-8 sm:items-center">
          <p className="max-w-screen-sm text-sm text-gray-500 lg:text-base">これはダミーテキストです。これはダミーテキストです。これはダミーテキストです。</p>

          <a href="#" className="inline-block rounded-lg border bg-white px-4 py-2 text-center text-sm font-semibold text-gray-500 outline-none ring-indigo-300 transition duration-100 hover:bg-gray-100 focus-visible:ring active:bg-gray-200 md:px-8 md:py-3 md:text-base">もっと見る</a>
        </div>
      </div>
    </div>
  );
